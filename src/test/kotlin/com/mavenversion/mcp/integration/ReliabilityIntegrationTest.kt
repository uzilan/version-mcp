...
class ReliabilityIntegrationTest {
    ...
    inner class LiveWebsiteIntegrationTests {
        ...
        fun shouldHandleRealMvnRepositoryWithRateLimiting() = runTest {
            // Initialize client
        ...
        fun shouldHandleNetworkInterruptionsGracefully() = runTest {
            val initResult = client.initialize()
            assertThat(initResult.isSuccess).isTrue()
        ...
        fun shouldRespectRateLimitsDuringBurstRequests() = runTest {
            val initResult = client.initialize()
            assertThat(initResult.isSuccess).isTrue()
    ...
    inner class ErrorRecoveryIntegrationTests {
        ...
        fun shouldRecoverFromTemporaryMCPServerDisconnections() = runTest {
        ...
        fun shouldHandleMalformedResponsesGracefully() = runTest {
            val initResult = client.initialize()
            assertThat(initResult.isSuccess).isTrue()
    ...
    inner class PerformanceAndReliabilityTests {
        ...
        fun shouldMaintainPerformanceUnderLoadWithReliabilityFeatures() = runTest {
            val initResult = client.initialize()
            assertThat(initResult.isSuccess).isTrue()
