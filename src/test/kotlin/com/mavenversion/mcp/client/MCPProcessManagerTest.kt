...
class MCPProcessManagerTest {
    ...
    inner class DefaultConfigurationTests {
        ...
        fun shouldProvidePlaywrightDefaultConfiguration() {
            ...
            assertThat(config.command).containsExactly("uvx", "playwright-mcp-server")
            assertThat(config.env).containsEntry("FASTMCP_LOG_LEVEL", "ERROR")
        }
        ...
        fun shouldProvidePlaywrightNpxConfiguration() {
            ...
            assertThat(config.name).isEqualTo("playwright")
            assertThat(config.command).containsExactly("npx", "@modelcontextprotocol/server-playwright")
    ...
    inner class ProcessManagementTests {
        ...
        fun shouldFailToGetClientWithInvalidCommand() = runTest {
            val manager = MCPProcessManager()
            val config = MCPServerConfig(
                name = "invalid-server",
        ...
        fun shouldHandleServerRestartFailure() = runTest {
            val manager = MCPProcessManager()
        ...
        fun shouldHandleServerStopForNonexistentServer() = runTest {
            val manager = MCPProcessManager()
        ...
        fun shouldHandleStopAllWithNoServers() = runTest {
            val manager = MCPProcessManager()
        ...
        fun shouldHandleHealthCheckForNonexistentServer() = runTest {
            val manager = MCPProcessManager()
